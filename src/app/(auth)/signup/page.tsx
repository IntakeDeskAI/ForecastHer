      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-center text-xs text-muted-foreground">
            ...
            <Link href="/privacy.html" className="underline">Privacy Policy</Link> and{" "}
            <Link href="/terms.html" className="underline">Terms of Service</Link>.
          </p>
        </CardContent>
      </Card>
    </div>
